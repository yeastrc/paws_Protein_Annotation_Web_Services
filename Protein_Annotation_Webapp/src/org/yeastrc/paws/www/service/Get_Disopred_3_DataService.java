...
public class Get_Disopred_3_DataService {
	 ...
	 * @throws Exception
	 */
	public String get_Disopred_3_DataForSequence( String sequenceToProcess, int ncbiTaxonomyId ) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public String get_Disopred_3_DataForSequenceId( int sequenceId, int ncbiTaxonomyId ) throws Exception {
	 ...
	 * @throws Exception 
	 */
	private String get_Disopred_3_DataForSequenceSequenceId( String sequence, int sequenceId, int ncbiTaxonomyId ) throws Exception {

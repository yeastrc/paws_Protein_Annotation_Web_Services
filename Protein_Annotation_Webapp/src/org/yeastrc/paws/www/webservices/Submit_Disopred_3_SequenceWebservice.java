...
//		String callbackQueryParamValue = request.getParameter( RestWebServiceJSONP_Constants.CALLBACK_QUERY_PARAMETER );
	...
	public String processSubmitInternal( 
		...
		try {
			String response = 
					Process_Disopred_3_SequenceSubmit.getInstance().
					process_Disopred_3_SequenceSubmit( sequenceToProcess, ncbiTaxonomyId, requestingIP, batchRequest, batchRequestId );

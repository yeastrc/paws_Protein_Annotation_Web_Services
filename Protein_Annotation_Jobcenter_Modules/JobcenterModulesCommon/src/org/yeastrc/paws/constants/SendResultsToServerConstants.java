...
public class SendResultsToServerConstants {
	
	
	public static final int SEND_RESULTS_INSERT_IN_PROGRESS_RETRY_COUNT = 4;

//	public static final int HTTP_CONNECTION_INSERT_IN_PROGRESS_RETRY_DELAY_MILLIS = 1000 * 60 * 60 * 5;  // 5 HOURS


	public static final int SEND_RESULTS_TIMEOUT_RETRY_COUNT = 4;
